  ...
  const strains = [
    {
      ...
      description: "A classic indica strain known for its deep relaxation effects and grape-like aroma. Perfect for evening use.",
      effects: ["Relaxing", "Sleep Aid", "Pain Relief"],
      type: "Indica"
    },
    {
      name: "Girl Scout Cookies",
      description: "A balanced hybrid offering euphoric effects with sweet and earthy flavors. Great for creativity and social activities.",
      effects: ["Euphoric", "Creative", "Social"],
      type: "Hybrid"
    },
    {
      name: "Sour Diesel",
      description: "An energizing sativa strain with a pungent, fuel-like aroma. Ideal for daytime productivity and focus.",
      effects: ["Energizing", "Focus", "Uplifting"],
      type: "Sativa"
    },
    {
      name: "Blue Dream",
      description: "California's most popular hybrid, offering balanced effects with sweet berry flavors and gentle cerebral invigoration.",
      effects: ["Balanced", "Gentle", "Versatile"],
      type: "Hybrid"
    }
  ];
